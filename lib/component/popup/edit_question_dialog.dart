...
class _EditQuestionDialog extends HookWidget {
  const _EditQuestionDialog(this.question, {required this.editQuizBloc});
                    ...
                    onPressed: () {
                      if (answersControllers.value.length < 2 ||
                        ...
                        if (formKey.currentState!.validate()) {
                          ...
                          final PostQuestionQueryDto query =
...
Future<bool> editQuestionPopup(
  BuildContext context, {
  Question? question,
  required EditQuizBloc editQuizBloc,
}) async =>
    await showDialog(
      context: context,
      builder: (_) => _EditQuestionDialog(question, editQuizBloc: editQuizBloc),
    ) ??
    false;
